...
const BYTE* GetTableCharFont1(char CharToGet)
{
	int FTableOffset = CharToGet * Font1Height;
	return &Font1[FTableOffset];
}
//------------------------------------------------------------------------------------

void GetFont1Paremeters(BYTE *Height,BYTE *Width)
{
  *Height = Font1Height;
  *Width = 8;
}
