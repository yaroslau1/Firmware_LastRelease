...
/* Определяет работу SDIO 1 бит или 4 бита */
#define	BIT_BAND_4BIT
...
/*----------------------------------------------------------------------------------*/
/* Returns status of SD card, cheking by hardware and software						*/
/*----------------------------------------------------------------------------------*/
/* SDCardState - enum type of error													*/
/*----------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------*/
/* Checking of SD card presence by hardware											*/
/*----------------------------------------------------------------------------------*/
...
SD_Error SD_ProcessIRQSrc(void)
{
  ...
  /*!< DMA2 Channel4 disable */
  DMA_Cmd(DMA2_Channel4, DISABLE);										/* 11111111111111 */
...
/*----------------------------------------------------------------------------------*/
/* @brief	Функция проверки наличия  SD карты										*/
/* @param	None																	*/
/* @return	None																	*/
/*----------------------------------------------------------------------------------*/
SD_Error SD_CheckPresence( void )
{
	SD_Error errorstatus = SD_OK;
