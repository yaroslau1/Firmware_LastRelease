...
/*----------------------------------------------------------------------------------*/
class TADS1298 : public TDSP
{
	public:
		static void ADS1298_Init( void );
    ...
    static void WakeUp();
		...
		static void GetConvertResult( void );
 		static bool GetConvertResultTest( void );


		static void ADS1298PHYInit( void );
		static void ADS1298PHYReinit( void );
		static void ADS1298PHYDeinit( void );
